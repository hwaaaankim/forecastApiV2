...
public enum ApiErrorResponse {
    ...
    UNKNOWN_ERROR(1003, "토큰이 존재하지 않습니다. 다시 로그인 해 주세요."),
	...
	ALREADY_USER(1015, "이미 가입한 wallet address 입니다. signin을 이용 해 주세요."),
	NOTFOUND_ERROR(1016, "존재하지 않는 request url 입니다."),
	DATABASE_ERROR(1017, "All required data are needed."),
